...
root = tk.Tk()
root.title("Lifeline Management System")
tabcontrol = ttk.Notebook(root)
Inventory = ttk.Frame(tabcontrol)
labelFrame = ttk.LabelFrame(Inventory,text="Client Management")
...
labelFrame1 = ttk.LabelFrame(Inventory,text="Client List",borderwidth=3)
...
productPrice = ttk.Label(labelFrame,text="Status: ")
